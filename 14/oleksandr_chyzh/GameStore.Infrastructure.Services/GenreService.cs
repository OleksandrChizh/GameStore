...
namespace GameStore.Infrastructure.Services
{
    public class GenreService : Service, IGenreService
    {
        ...
        public IEnumerable<GenreDto> GetDirectSubGenres(int genreId)
        {
            IEnumerable<Genre> genres = UnitOfWork.Genres.Find(g => g.ParentGenre != null && g.ParentGenre.Id == genreId);
            return genres.Select(g => g.ToDto());
        }
