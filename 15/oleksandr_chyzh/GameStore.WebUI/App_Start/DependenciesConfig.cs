...
namespace GameStore.WebUI
{
    public class DependenciesConfiguration
    {
        public static IKernel RegisterDependencies(StandardKernel kernel)
        {
            ...
            kernel.Bind<Services.Interfaces.IEmailService>().To<Infrastructure.Services.EmailService>();
            kernel.Bind<Services.Interfaces.ISmsService>().To<Infrastructure.Services.SmsService>();
            kernel.Bind<IMobileAppNotificationService>().To<MobileAppNotificationService>();
            kernel.Bind<IOrderPaidNotificationCenter>().To<OrderPaidNotificationCenter>();
